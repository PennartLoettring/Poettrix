...
"x86_64-linux-thread-multi-3.16.2-1-arch" or
	die "Errno architecture (x86_64-linux-thread-multi-3.16.2-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
